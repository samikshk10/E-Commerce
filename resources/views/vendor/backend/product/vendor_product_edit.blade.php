                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="col-12">
                        ...
                        <div class="form-check">
                          <input type="checkbox" name="hot_deals" value="1" id="flexCheckDefault" class="form-check-input" {{ $products->hot_deals == 1 ? 'checked' : ''}}>

                          <label for="flexCheckDefault" class="form-check-default">Hot Deals</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-check">
                          <input type="checkbox" value="1" id="flexCheckDefault" class="form-check-input" name="featured" {{ $products->featured == 1 ? 'checked' : ''}}>

                          <label for="flexCheckDefault" class="form-check-default">Featured</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-check">
                          <input type="checkbox" value="1" id="flexCheckDefault" class="form-check-input" name="special_offer" {{ $products->special_offer == 1 ? 'checked' : ''}}>

                          <label for="flexCheckDefault" class="form-check-default">Special Offer</label>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-check">
                          <input type="checkbox" value="1" id="flexCheckDefault" class="form-check-input" name="special_deals" {{ $products->special_deals == 1 ? 'checked' : ''}}>

                          <label for="flexCheckDefault" class="form-check-default">Special Deals</label>
                        </div>
                      </div>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="mb-3">
            <label for="formFile" class="form-label">Update Thumbnail Image</label>
