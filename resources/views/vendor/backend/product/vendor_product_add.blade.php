               ...
               <div class="border border-3 p-4 rounded">
                ...
                <div class="form-group mb-3">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input name="product_thambnail" type="file" class="form-control" id="formFile" onChange="mainThamUrl(this)" >
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="col-12">
                        ...
                        <div class="form-check">
                          <input type="checkbox" name="hot_deals" value="1" id="flexCheckDefault" class="form-check-input">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-check">
                          <input type="checkbox" value="1" id="flexCheckDefault" class="form-check-input" name="featured">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-check">
                          <input type="checkbox" value="1" id="flexCheckDefault" class="form-check-input" name="special_offer">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-check">
                          <input type="checkbox" value="1" id="flexCheckDefault" class="form-check-input" name="special_deals">
